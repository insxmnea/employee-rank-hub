  ...
  return (
    ...
    >
      <div className={styles.links}>
        ...
        <AppLink to={RoutePath.subdivision_table} className={styles.link}>
          <i className="nf nf-cod-symbol_structure"></i>
          <span className={styles.linkText}>{t("Подразделения")}</span>
        </AppLink>
